  ...
  )
{
  ...
  /*
   * TODO: These regions' base addresses depend on the amount of RAM. This code
   * is only valid with <256GiB of RAM. Although that may seem like a lot, it is
   * possible regardless of the amount of host RAM, because QEMU allows to
   * create a large chunk of addressing space in order to enable memory hotplug.
   */
